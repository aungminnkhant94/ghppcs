...
if($_POST) {
    ...
    if(isset($_POST['service_preference'])) {
        $service_type = filter_var($_POST['service_preference'], FILTER_SANITIZE_STRING);
    }
    ...
    $email_content .= "<tr><td style='background: #eee; padding: 10px;'>Phone</td><td style='background: #fda; padding: 10px;'>$visitor_phone</td></tr>";
    $email_content .= "<tr><td style='background: #eee; padding: 10px;'>Service Type</td><td style='background: #fda; padding: 10px;'>$service_type</td></tr></tbody></table>";
    ...
    if(mail($recipient, "Customer Inquiry from Contact Us Page", $email_content, $headers)) {
